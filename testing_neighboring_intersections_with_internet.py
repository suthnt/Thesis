...
csv_path = '/scratch/gpfs/ALAINK/Suthi/CleanedCrashes_5Years_BikePed.csv'
pts = pd.read_csv(csv_path)   # expects columns: LONGITUDE, LATITUDE
...
out.to_file(
    "/scratch/gpfs/ALAINK/Suthi/SafeIntersections_5Years.geojson",
    driver="GeoJSON"
)

out.to_csv(
    "/scratch/gpfs/ALAINK/Suthi/SafeIntersections_5Years.csv",
    index=False
)
