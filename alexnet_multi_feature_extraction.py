...
# === CONFIG ===
MODEL_PATH = "/scratch/gpfs/ALAINK/Suthi/best_AlexNet_multi_1year.keras"
DATASET_DIR = "/scratch/gpfs/ALAINK/Suthi/OrganizedDatasetBalancedBinary"
OUTPUT_DIR = "/scratch/gpfs/ALAINK/Suthi/alexnet_multi_features_1year"
IMG_SIZE = 227
BATCH_SIZE = 32

os.makedirs(OUTPUT_DIR, exist_ok=True)

print("=== AlexNet Multi-Class Feature Extraction ===")
...
def extract_split(split):
    ...
    for label_name in ["safe", "dangerous"]:
        ...
        print(f"  {split}/{label_name}: {len(images)}")
...
print("\n=== Done ===")
print("Add to meta_classifier FEATURE_DIRS:")
print(f"  \"{OUTPUT_DIR}\"")
